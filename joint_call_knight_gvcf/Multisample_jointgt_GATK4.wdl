...
workflow JointGenotyping {
  ...
  Array[String] unpadded_intervals = read_lines(interval_bed_files)  


  #scatter (idx in range(length(unpadded_intervals))) {
  scatter (interval_file in unpadded_intervals) {
...
task ImportGVCFs {
  ...
  command <<<
    ...
    # Get rid of padding (i.e. -ip option)
